...
// Діалоги
// Просто виводить діалог з повідомленням
// alert("You just  open this page. Welcome, pal");

// Діалог в якому у користувача запитують якесь значення, завжди повертає string
/*const result = prompt("Hello what your name?");
alert(`Hello, ${result}`);*/
...
/*
Примітиви
Number: 10, 1, 2.5, 5.5, Infinity, NaN
BigInt: 2^53, let bigNumber = 314314124124141241241241241n
String: "Hello, world" = 'Hello, world' = `Hello, world`
`` - цей тип лапок використовується щоб підставляти значення змінних. Інтерполяція: 
let value = 'Text'
console.log(`${Text}`)
Boolean: true/false
null: nothing
undefined: задається автоматично JS, якщо змінна була створена без значення

Symbol: ідентифікатор, який є унікальним та незмінним.

Refference/скалдний тип
Object
let user = {
    name: "John",
    age: 30
...
typeof - оператор який дає можливість визначити тип
*/
...
Запросіть у користувача відстань у кілометрах між двома містами та за скільки годин він хоче дістатися. Порахуйте швидкість, з якою потрібно рухатися, щоб встигнути вчасно.

Реалізуйте конвертор валют. Користувач вводить долари, програма конвертує у євро. Курс валюти зберігайте у константі.
...
Запросіть у користувача ціле число і виведіть у відповідь парне або непарне. В завданні використовуйте логічні оператори і не використовуйте if та switch.
*/